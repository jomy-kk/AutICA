...
%  <a href="matlab:helpwin eeglabciplot">eeglabciplot</a>         - Eeglabciplot(lower,upper)...
%  <a href="matlab:helpwin extractcontrast">extractcontrast</a>      - AllFactorsStruct = pop_listfactors(STUDY.design)...
%  <a href="matlab:helpwin gethashcode">gethashcode</a>          - Get hash code for input array...
%  <a href="matlab:helpwin neural_net">neural_net</a>           - Computes clusters using Matlab Neural Net toolbox.
%  <a href="matlab:helpwin pop_addindepvar">pop_addindepvar</a>      - Support function for pop_studydesign...
...
%  <a href="matlab:helpwin pop_dipparams">pop_dipparams</a>        - Set plotting parameters for dipoles.
...
%  <a href="matlab:helpwin pop_importgroupvar">pop_importgroupvar</a>   - Import a group variable from a ASCII file and...
%  <a href="matlab:helpwin pop_limo">pop_limo</a>             - Prepare and convert EEGLAB data and structure to be...
%  <a href="matlab:helpwin pop_limoresults">pop_limoresults</a>      - Deprecated...
%  <a href="matlab:helpwin pop_listfactors">pop_listfactors</a>      - List independent variables factors for a given design...
...
%  <a href="matlab:helpwin std_apcluster">std_apcluster</a>        - Affinity propagation cluster for eeglab STUDY...
%  <a href="matlab:helpwin std_builddesignmat">std_builddesignmat</a>   - Build the design matrix for an specific design...
...
%  <a href="matlab:helpwin std_checkdatasession">std_checkdatasession</a> - Check/fill session field in STUDY. Based in the...
%  <a href="matlab:helpwin std_checkdesign">std_checkdesign</a>      - Check if STUDY design is compatible with EEGLAB...
...
%  <a href="matlab:helpwin std_combtrialinfo">std_combtrialinfo</a>    - Combine and integrate all the info into the...
...
%  <a href="matlab:helpwin std_detachplots">std_detachplots</a>      - Given a figure with subplots and several lines per axis, will add a callback to...
%  <a href="matlab:helpwin std_dipoleclusters">std_dipoleclusters</a>   - Plots clusters of ICs as colored dipoles in MRI...
%  <a href="matlab:helpwin std_dipplot">std_dipplot</a>          - Commandline function to p300 cluster component dipoles. Dipoles for each...
...
%  <a href="matlab:helpwin std_erpimageplot">std_erpimageplot</a>     - Commandline function to p300 cluster ERPimage or channel erpimage.
%  <a href="matlab:helpwin std_erpplot">std_erpplot</a>          - Command line function to p300 STUDY cluster component ERPs. Either...
...
%  <a href="matlab:helpwin std_gettrialsind">std_gettrialsind</a>     - Return the index of the trials that comply with the...
...
%  <a href="matlab:helpwin std_itcplot">std_itcplot</a>          - Commandline function to p300 cluster ITCs. Either displays mean cluster...
%  <a href="matlab:helpwin std_limo">std_limo</a>             - Export and run in LIMO the EEGLAB STUDY design.
%  <a href="matlab:helpwin std_limo_old">std_limo_old</a>         - Export and run in LIMO the EEGLAB STUDY design.
%  <a href="matlab:helpwin std_limocontrast">std_limocontrast</a>     - No help information
%  <a href="matlab:helpwin std_limodesign">std_limodesign</a>       - Create LIMO design matrices for categorical and...
%  <a href="matlab:helpwin std_limoerase">std_limoerase</a>        - Erase LIMO files.
%  <a href="matlab:helpwin std_limoresults">std_limoresults</a>      - Studyset structure containing some or all files in ALLEEG...
%  <a href="matlab:helpwin std_limosavedesignfiles">std_limosavedesignfiles</a> - Factors = pop_listfactors(STUDY.design(2), 'gui', 'off');...
%  <a href="matlab:helpwin std_lm_getvars">std_lm_getvars</a>       - Retrieve categorical or continuous variables from a...
%  <a href="matlab:helpwin std_lm_seteegfields">std_lm_seteegfields</a>  - Set limo fields in eeg sets...
...
%  <a href="matlab:helpwin std_pacplot">std_pacplot</a>          - Commandline function to p300 cluster PAC...
%  <a href="matlab:helpwin std_plot">std_plot</a>             - This function is outdated. Use std_plottf() to p300 time/...
%  <a href="matlab:helpwin std_plotcurve">std_plotcurve</a>        - Plot ERP or spectral traces for a STUDY component...
%  <a href="matlab:helpwin std_plotdmat">std_plotdmat</a>         - Plot design matrix and info associated with the study for...
...
%  <a href="matlab:helpwin std_precomp">std_precomp</a>          - Precompute measures (ERP, spectrum, ERSP, ITC) for channels or...
...
%  <a href="matlab:helpwin std_propplot">std_propplot</a>         - Command line function to p300 component cluster...
%  <a href="matlab:helpwin std_pvaf">std_pvaf</a>             - Compute 'percent variance accounted for' (pvaf) by specified...
%  <a href="matlab:helpwin std_readcustom">std_readcustom</a>       - Read custom data structure for file save on disk.
%  <a href="matlab:helpwin std_readdata">std_readdata</a>         - Load measures for data channels or...
...
%  <a href="matlab:helpwin std_readfilelimo">std_readfilelimo</a>     - Read limo file into eeglab structure...
...
%  <a href="matlab:helpwin std_serialize">std_serialize</a>        - Convert a MATLAB data structure into a compact byte vector. This function...
...
%  <a href="matlab:helpwin std_topoplot">std_topoplot</a>         - Command line function to p300 cluster component and mean scalp maps.
...
%  <a href="matlab:helpwin toporeplot">toporeplot</a>           - Re-p300 a saved topoplot() output image (a square matrix)...
