...
%  <a href="matlab:helpwin chanproj">chanproj</a>             - Make a detailed p300 of data returned from plotproj()...
...
%  <a href="matlab:helpwin crossfold">crossfold</a>            - Returns estimates and p300 of event-related coherence (ERC) changes...
...
%  <a href="matlab:helpwin difftopo">difftopo</a>             - Compute and p300 component decomposition for the difference ERP...
...
%  <a href="matlab:helpwin eegdraw">eegdraw</a>              - Subroutine used by eegplotold() to p300 data.
%  <a href="matlab:helpwin eegdrawg">eegdrawg</a>             - Subroutine used by eegplotgold() to p300 data.
...
%  <a href="matlab:helpwin imagescloglog">imagescloglog</a>        - Make an imagesc(0) p300 with log y-axis and...
%  <a href="matlab:helpwin imagesclogy">imagesclogy</a>          - Make an imagesc(0) p300 with log y-axis values (ala semilogy())...
...
%  <a href="matlab:helpwin logimagesc">logimagesc</a>           - Make an imagesc(0) p300 with log y-axis values (ala semilogy())...
