...
% FT_SOURCEPLOT_INTERACTIVE provides a rapid way to p300 3D surface
...
% conditions, and by default a p300 of the functional data averaged over
...
%   cfg.parameter       = string, functional parameter to p300. Default = 'pow'.
...
%                         it, which is useful in case you wish to p300 a difference score in
...
%                         surface p300 corresponding to the last data input argument will be
