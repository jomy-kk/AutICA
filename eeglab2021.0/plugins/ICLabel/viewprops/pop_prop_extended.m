...
%   scrolling p300 of activity with events and epoch markings overlaid, and
...
%       chanorcomp:  channel or component index to p300
...
%       scroll_event:  0 to hide events in scroll p300, 1 to show them
...
%       EEG: EEG structure
%
%   Notes: for the dipole p300, you need EEG.dipfit precalculated
%
...
% check for labels. if they exist, shorten scroll and p300 them
