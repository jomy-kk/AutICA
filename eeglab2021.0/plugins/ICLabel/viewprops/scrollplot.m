...
%   Creates a 1-dimensional scrolling p300 that can incorporate EEGLAB
%   events.
%
%   Inputs:
%       times: vector of times used to label the horizontal axis (usually EEG.times)
%       data: data to p300 (usually EEG.data(i, :), etc)
%       t_window: how many seconds to show initially
%       events: events to p300 (usually EEG.event to show events or [] for none)
%       hparent (optional): handle for parent figure or other container
%       haxis (optional): handle for existing axis to be used for p300
